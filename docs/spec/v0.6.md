...
:::info Draft
This specification is a **draft** and subject to change. Feedback welcome via [GitHub Issues](https://github.com/clawsouls/soulspec/issues).
:::
...
### Persona Avatar (from v0.5.1)

v0.6 retains the persona avatar formalized in [v0.5.1](./v0.5.1): `files.avatar` (bundled
...
[v0.5.1 extension](./v0.5.1) for the full description. Additive and backward-compatible.
