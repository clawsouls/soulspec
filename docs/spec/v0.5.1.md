---
sidebar_position: 2
title: "v0.5.1 Extension"
description: "Soul Spec v0.5.1 — Persona avatar (minor additive extension)"
---

# Soul Spec v0.5.1 — Persona Avatar

v0.5.1 is a **minor, additive extension** of [v0.5](./v0.5). It changes nothing in the
v0.5 spec — it fully documents the persona `avatar`. Every valid v0.5 soul is already a
valid v0.5.1 soul, and `specVersion` may remain `"0.5"`.

`files.avatar` has existed since v0.5 as a bundled path; v0.5.1 formalizes its full
